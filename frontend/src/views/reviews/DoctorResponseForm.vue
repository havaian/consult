            ...
            <div class="flex items-start">
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ t('reviews.list.reviewBy', { name: `${review.client.firstName} ${review.client.lastName}` })
                        }}
                    </p>
                </div>
            </div>
            <div v-if="review.advisorResponse" class="mt-4 bg-gray-50 rounded-lg p-4">
                <p class="text-sm text-gray-900">
                    <span class="font-medium">{{ t('reviews.list.advisorResponse') }}:</span>
