        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
                ...
                <div class="flex items-center justify-between">
                    <div class="text-sm">
                        <a href="#" @click.prevent="forgotPassword" class="font-medium bg-gradient-to-r from-royal-gold to-charcoal bg-clip-text text-transparent  hover:text-indigo-500">
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                ...
                <a href="#" @click.prevent="goToRegister" class="font-medium bg-gradient-to-r from-royal-gold to-charcoal bg-clip-text text-transparent  hover:text-indigo-500">
                    Sign up
                </a>
            </p>
