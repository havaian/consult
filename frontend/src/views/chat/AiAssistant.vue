    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div class="p-4 border-b border-gray-200">
                <h1 class="text-lg font-medium text-gray-900">AI Legal Assistant</h1>
                ...
                <div class="space-y-4">
                    <template v-if="messages.length === 0">
                        <div class="text-center text-gray-500">
                            <p>👋 Hi! I'm your AI legal assistant.</p>
                    ...
                    <div v-for="message in messages" :key="message.id" class="flex mb-4"
                        ...
                        <div v-if="message.sender === 'assistant'" class="flex-shrink-0 mr-3">
                            <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                <svg class="h-6 w-6 bg-gradient-to-r from-legal-blue to-legal-teal bg-clip-text text-transparent " fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
            ...
            <div class="p-4 border-t border-gray-200">
                ...
                <div class="mt-3 flex justify-between items-center">
                    <p class="text-xs text-gray-500">
                        Note: This is for general information only. Always consult a advisor for legal advice.
                    </p>
