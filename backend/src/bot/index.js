...
//         try {
//             await ctx.reply(
//                 "👋 Welcome to Online-consult.com bot!\n\n" +
//                 "I can help you manage your legal appointments and consultations.\n\n" +
//                 "Here's what you can do:\n" +
//                 "- Link your Online-consult.com account\n" +
//                 "- View your upcoming appointments\n" +
//                 "- Get reminders for consultations\n" +
//                 "- Chat with virtual legal assistant\n\n" +
//                 "To begin, please use the /link command to connect your Online-consult.com account."
//             );
//         } catch (error) {
...
//                 "/start - Start the bot\n" +
//                 "/link - Link your Online-consult.com account\n" +
//                 "/appointments - View your appointments\n" +
//                 "/profile - View your profile\n" +
//                 "/unlink - Unlink your account\n" +
//                 "/assistant - Chat with legal assistant\n\n" +
//                 "If you need further assistance, contact support@online-consult.com"
//             );
//         } catch (error) {
...
//             await ctx.reply(
//                 "To link your Online-consult.com account, I'll need your email address.\n\n" +
//                 "Please enter the email you used to register on Online-consult.com:"
//             );
//         } catch (error) {
...
//                         await ctx.reply("❌ Email not found. Please make sure your email is registered with Online-consult.com.");
...
//                         await ctx.reply(
//                             "🎉 Your Online-consult.com account has been successfully linked!\n\n" +
...
//                 await ctx.reply(
//                     "You need to link your Online-consult.com account first. Use /link to get started."
//                 );
//                 return;
//             }
...
//                     if (!appointment.dateTime || !appointment.advisor) {
...
//                     const advisorName = appointment.advisor.firstName && appointment.advisor.lastName ? 
//                         `${appointment.advisor.firstName} ${appointment.advisor.lastName}` : 
//                         "Unknown advisor";

//                     message += `${index + 1}. Advisor: ${advisorName}\n`;
...
//             if (!user) {
//                 await ctx.reply(
//                     "Your account is not linked. Use /link to connect your Online-consult.com account."
//                 );
//                 return;
//             }
...
//             await ctx.reply(
//                 "⚠️ Are you sure you want to unlink your Online-consult.com account? You will no longer receive notifications.\n\n" +
...
//             await ctx.reply(
//                 "👨‍⚕️ I'm the Online-consult.com virtual legal assistant. I can answer general legal questions and provide health information.\n\n" +
...
//                 const response = await axios.get(
//                     `${process.env.API_URL}/advisors/specializations`
//                 );
...
//                 let message = "Please select a legal specializations:\n\n";
...
//             // Fetch advisors with this specializations
//             const response = await axios.get(
//                 `${process.env.API_URL}/advisors?specializations=${encodeURIComponent(selectedSpecialization)}`,
//                 {
//                     headers: {
//                         'Authorization': `Bearer ${ctx.session.userData.token}`
//                     }
...
//                 await ctx.reply(
//                     `No advisors available for ${selectedSpecialization}. Please select another specializations or try again later.`
//                 );
//                 ctx.session.step = 'idle';
//                 return;
//             }
            
//             ctx.session.advisors = advisors;
//             ctx.session.step = 'appointment_advisor';
            
//             let message = `Please select a advisor for ${selectedSpecialization}:\n\n`;
//             advisors.forEach((advisor, index) => {
//                 message += `${index + 1}. Dr. ${advisor.firstName} ${advisor.lastName}\n`;
//                 message += `   Experience: ${advisor.experience} years\n`;
//                 message += `   Fee: ${advisor.consultationFee} 'UZS'\n\n`;
//             });
...
//                 if (!user) {
//                     await ctx.reply("Your account is not linked to Online-consult.com.");
//                     ctx.session.step = 'idle';
//                     return;
//                 }
...
//                 await ctx.reply(
//                     "✅ Your Online-consult.com account has been unlinked successfully.\n\n" +
...
//             }
//         } else if (answer === 'no' || answer === 'n') {
//             await ctx.reply("Account unlinking canceled. Your account remains linked to Online-consult.com.");
//         } else {
//             await ctx.reply("Please answer with Yes or No.");
