...
//         try {
//             await ctx.reply(
//                 "👋 Welcome to consult.ytech.space bot!\n\n" +
//                 "I can help you manage your legal appointments and consultations.\n\n" +
//                 "Here's what you can do:\n" +
//                 "- Link your consult.ytech.space account\n" +
//                 "- View your upcoming appointments\n" +
//                 "- Get reminders for consultations\n" +
//                 "- Chat with virtual legal assistant\n\n" +
//                 "To begin, please use the /link command to connect your consult.ytech.space account."
//             );
//         } catch (error) {
...
//                 "/start - Start the bot\n" +
//                 "/link - Link your consult.ytech.space account\n" +
...
//             await ctx.reply(
//                 "To link your consult.ytech.space account, I'll need your email address.\n\n" +
//                 "Please enter the email you used to register on consult.ytech.space:"
//             );
//         } catch (error) {
...
//                         await ctx.reply("❌ Email not found. Please make sure your email is registered with consult.ytech.space.");
...
//                         await ctx.reply(
//                             "🎉 Your consult.ytech.space account has been successfully linked!\n\n" +
...
//                 await ctx.reply(
//                     "You need to link your consult.ytech.space account first. Use /link to get started."
//                 );
//                 return;
//             }
...
//             if (!user) {
//                 await ctx.reply(
//                     "Your account is not linked. Use /link to connect your consult.ytech.space account."
//                 );
//                 return;
//             }
...
//             await ctx.reply(
//                 "⚠️ Are you sure you want to unlink your consult.ytech.space account? You will no longer receive notifications.\n\n" +
...
//             await ctx.reply(
//                 "👨‍⚕️ I'm the consult.ytech.space virtual legal assistant. I can answer general legal questions and provide health information.\n\n" +
...
//                 if (!user) {
//                     await ctx.reply("Your account is not linked to consult.ytech.space.");
//                     ctx.session.step = 'idle';
//                     return;
//                 }
...
//                 await ctx.reply(
//                     "✅ Your consult.ytech.space account has been unlinked successfully.\n\n" +
...
//             }
//         } else if (answer === 'no' || answer === 'n') {
//             await ctx.reply("Account unlinking canceled. Your account remains linked to consult.ytech.space.");
//         } else {
//             await ctx.reply("Please answer with Yes or No.");
