...
//                 "/start - Start the bot\n" +
//                 "/link - Link your e-consult.uz account\n" +
//                 "/appointments - View your appointments\n" +
//                 "/profile - View your profile\n" +
//                 "/unlink - Unlink your account\n" +
//                 "/assistant - Chat with legal assistant\n\n" +
//                 "If you need further assistance, contact consult@e-consult.uz"
//             );
//         } catch (error) {
...
//             await ctx.reply(
//                 "To link your e-consult.uz account, I'll need your email address.\n\n" +
//                 "Please enter the email you used to register on e-consult.uz:"
//             );
//         } catch (error) {
...
//                         await ctx.reply("❌ Email not found. Please make sure your email is registered with e-consult.uz.");
...
//                         await ctx.reply(
//                             "🎉 Your e-consult.uz account has been successfully linked!\n\n" +
...
//                 await ctx.reply(
//                     "You need to link your e-consult.uz account first. Use /link to get started."
//                 );
//                 return;
//             }
...
//             if (!user) {
//                 await ctx.reply(
//                     "Your account is not linked. Use /link to connect your e-consult.uz account."
//                 );
//                 return;
//             }
...
//             await ctx.reply(
//                 "⚠️ Are you sure you want to unlink your e-consult.uz account? You will no longer receive notifications.\n\n" +
...
//             await ctx.reply(
//                 "👨‍⚕️ I'm the e-consult.uz virtual legal assistant. I can answer general legal questions and provide health information.\n\n" +
...
//                 if (!user) {
//                     await ctx.reply("Your account is not linked to e-consult.uz.");
//                     ctx.session.step = 'idle';
//                     return;
//                 }
...
//                 await ctx.reply(
//                     "✅ Your e-consult.uz account has been unlinked successfully.\n\n" +
...
//             }
//         } else if (answer === 'no' || answer === 'n') {
//             await ctx.reply("Account unlinking canceled. Your account remains linked to e-consult.uz.");
//         } else {
//             await ctx.reply("Please answer with Yes or No.");
