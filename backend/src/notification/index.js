...
class NotificationService {
    ...
    async sendVerificationEmail(email, token) {
        ...
        const emailData = {
            to: email,
            subject: 'Verify Your Email - Online-consult.com',
            text: `Please verify your email by clicking on the following link: ${verificationLink}`,
            html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #4a90e2;">Online-consult.com Email Verification</h2>
          <p>Thank you for registering with Online-consult.com! Please verify your email address by clicking the button below:</p>
          ...
          <p>If you didn't create an account with Online-consult.com, please ignore this email.</p>
        </div>
      `
        };
    ...
    async sendPasswordResetEmail(email, token) {
        ...
        const emailData = {
            to: email,
            subject: 'Reset Your Password - Online-consult.com',
            text: `You requested a password reset. Please click the following link to reset your password: ${resetLink}`,
            html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #4a90e2;">Online-consult.com Password Reset</h2>
    ...
    async sendAppointmentConfirmation(appointment) {
        ...
        `
            ...
            const advisorEmailData = {
                to: advisor.email,
                subject: 'New Appointment - Online-consult.com',
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>You can view appointment details and join the consultation by logging into your Online-consult.com account.</p>
          </div>
        `
            };
    ...
    async sendAppointmentCancellation(appointment) {
        try {
            ...
            const clientEmailData = {
                to: client.email,
                subject: 'Appointment Canceled - Online-consult.com',
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>You can schedule a new appointment by logging into your Online-consult.com account.</p>
          </div>
        `
            };
    ...
    async sendAppointmentCompletionNotification(appointment) {
        try {
            ...
            const clientEmailData = {
                to: client.email,
                subject: 'Appointment Completed - Online-consult.com',
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>If any advices were provided, you can view them in your Online-consult.com account.</p>
    ...
    async sendAdviceNotification(appointment) {
        ...
        `;
            ...
            const clientEmailData = {
                to: client.email,
                subject: 'New Advices - Online-consult.com',
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>You can view these advices anytime by logging into your Online-consult.com account.</p>
          </div>
        `
            };
            ...
            if (client.telegramId) {
                const telegramData = {
                    chatId: client.telegramId,
                    text: `💊 Dr. ${advisor.firstName} ${advisor.lastName} has added advices to your recent appointment. Check your email or Online-consult.com account for details.`,
                    options: {
                        parse_mode: 'HTML'
                    }
                };
    ...
    async sendFollowUpNotification(followUpAppointment) {
        try {
            ...
            const clientEmailData = {
                to: client.email,
                subject: 'Follow-up Appointment Scheduled - Online-consult.com',
    ...
    async sendConsultationStartNotification(appointment) {
        try {
            ...
            const clientEmailData = {
                to: client.email,
                subject: 'Your Consultation Starts Soon - Online-consult.com',
        ...
        `
            ...
            const advisorEmailData = {
                to: advisor.email,
                subject: 'Consultation Starts Soon - Online-consult.com',
    ...
    async sendPaymentSuccessEmail(paymentId, appointment) {
        try {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>You can view your appointment details in your Online-consult.com account.</p>
          </div>
        `
            };
    ...
    async sendAdvisorAppointmentEmail(appointment) {
        try {
            ...
            const emailData = {
                to: advisor.email,
                subject: 'New Appointment Confirmed - Online-consult.com',
                html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>Please log in to your Online-consult.com account to view the appointment details.</p>
          </div>
        `
            };
    ...
    async sendPaymentFailureEmail(paymentId, appointment) {
        try {
            ...
            const emailData = {
                to: client.email,
                subject: 'Payment Failed - Online-consult.com',
                html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
