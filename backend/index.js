...
app.use((req, res, next) => {
    ...
    const sanitizeXSS = (str, fieldName) => {
        ...
        const fieldsToPreserveQuotes = ['bio', 'shortDescription', 'consultationSummary', 'notes', 'text', 'comment'];
...
app.use((req, res, next) => {
    ...
    //             'bio', 'shortDescription', 'consultationSummary',
...
const limiter = rateLimit({
    ...
    message: (req, res) => req.t('errors.tooManyRequests') 
});
app.use('/api', limiter);
